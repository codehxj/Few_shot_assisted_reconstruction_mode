...
class NetGSR(nn.Module):
    def __init__(self):
        super(NetGSR, self).__init__()
        ...
        num_layer = 3
        min_nfc = 32
        self.head = ConvBlock(nc_im,N,ker_size,padd_size,1) #GenConvTransBlock(opt.nc_z,N,opt.ker_size,opt.padd_size,opt.stride)
